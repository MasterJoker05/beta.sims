<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-2">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-4">
		<h4 class="letter-spacing-ct"><i class="fas fa-tasks"></i> LIST OF PROGRAMS</h4>
	</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-5">
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-4">
	    	<button id="btnAdd" data-bs-toggle="modal" data-id="0" data-bs-target="#form" class="btn btn-primary btn-sm letter-spacing-ct pull-right-add"><i class="fas fa-plus"></i> Add Program</button>
		</div>
				...
				<div class="table-responsive">
					<table class="table table-hover table-bordered table-condensed">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $ctr++; ?></td>
								<td><?php echo $program->CollegeCode ?></td>
								...
								<td class="text-center"><a data-bs-toggle="modal" data-bs-target="#form" class="btn btnEdit btn-success btn-sm "
									data-id="<?php echo $program->ProgramId;?>"><i class="fas fa-edit"></i> Edit</a>
...
<?php $this->load->view('program/modal'); ?>
<?php #$this->load->view('program/single'); ?>
