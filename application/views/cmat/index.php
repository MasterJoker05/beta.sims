<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-5">
	<form action="<?php echo base_url('cmat/'.$this->uri->segment(2)) ?>" method="post" class="row g-3" role="form">	
			...
			<div class="table-responsive">
				<table class="table table-hover table-bordered table-condensed">
					...
					<tbody>
						...
						<tr>
							<td><?php echo $ctr++; ?></td>
							<td><?php echo proper_date($cmat_list->confirm_at) ?></td>
							...
							<td>
								...
								<?php endif ?></td>
							<td><a href="<?php echo base_url('cmat/view/').$cmat_list->cmat_id ?>" class="btn btn-success btn-sm">View</a></td>
						</tr>
						<?php endforeach ?>
					</tbody>
				</table>
