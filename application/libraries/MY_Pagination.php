...
class MY_Pagination extends CI_Pagination
{
    ...
    public function __construct()
    {
        ...
        $config_style['full_tag_open'] = '<nav aria-label="Page navigation example"> <ul class="pagination justify-content-center pagination-ct">';
        $config_style['full_tag_close'] = '</ul></nav>';

        $config_style['first_link'] = TRUE;
        $config_style['last_link'] = TRUE;

        $config_style['first_link'] = '&larr; First';
        $config_style['first_tag_open'] = '<li class="page-item disabled">';
        $config_style['first_tag_close'] = '</li>';

        $config_style['last_link'] = 'Last &rarr;';
        $config_style['last_tag_open'] = '<li class="page-item">';
        $config_style['last_tag_close'] = '</li>';

        $config_style['next_link'] = 'Next &raquo;';
        $config_style['next_tag_open'] = '<li class="page-item">';
        $config_style['next_tag_close'] = '</li>';

        $config_style['prev_link'] = '&laquo; Previous';
        $config_style['prev_tag_open'] = '<li class="page-item">';
        $config_style['prev_tag_close'] = '</li>';

        $config_style['cur_tag_open'] = '<li class="page-item active"><a class="page-link" href="#">';
        $config_style['cur_tag_close'] = '</a></li>';
        $config_style['num_tag_open'] = '<li class="page-item">';
